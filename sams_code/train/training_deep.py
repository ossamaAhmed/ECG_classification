...
class Model(object):
    ...
    def build_model(self):
        ...
        with tf.name_scope('model'):
            ...
            conv1 = tf.layers.max_pooling1d(conv1, 3, 3)
            ...
            conv2 = tf.layers.max_pooling1d(conv2, 3, 3)
            ...
            conv3 = tf.layers.max_pooling1d(conv3, 3, 3)
            ...
            conv4 = tf.layers.max_pooling1d(conv4, 3, 3)
            #print("Hola", conv4)
            ...
            conv5 = tf.layers.max_pooling1d(conv5, 3, 3)
            ...
            conv6 = tf.layers.max_pooling1d(conv6, 3, 3)
